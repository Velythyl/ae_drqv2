...
class Gait(nn.Module):
    ...
    def forward(self, frame_nb):
        ...
        mixed = self.cyclic_gaussian_mixture(frame_nb_batch).squeeze()
...
if __name__ == "__main__":
    ...
    y = torch.normal(0.2, 1, (FRAMES,2), requires_grad=False)
    y2 = torch.normal(0.2, 1, (FRAMES,2), requires_grad=False)
    y = y + y2
